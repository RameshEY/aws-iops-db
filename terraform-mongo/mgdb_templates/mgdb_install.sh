...
#consider: send this value from terraform
DEVICE_NAME=xvdh
...
grep mongodb /etc/passwd /etc/group

chown -R mongodb:mongodb ${mongodb_basedir}
...
#
# configure mongodb
#   commented security implies no auth
#
